...
import com.oa.service.document.DocumentService;
import com.oa.service.employee.EmployeeService;
 ...
 * @Description 收发文控制器
 * @Author JohnTang
 * @LastChangeDat       e 2020/11/12 11:01
 * @Version v1.0
 */
...
public class DocumentController {
    ...
    BackFrontMessage getAllDepartment(){
        return documentService.getAllDepartment();
    }
