package com.example.scheduleservice.filter;

import com.example.scheduleservice.config.GlobalSecurityConfig;
import com.example.scheduleservice.request.RequestEmployeeData;
import com.example.scheduleservice.utils.NotLoginException;
...
public class CustomFilterInvocationSecurityMetadataSource implements FilterInvocationSecurityMetadataSource{
    ...
    public Collection<ConfigAttribute> getAttributes(Object o) throws IllegalArgumentException,AuthenticationException {
        ...
        if (requestEmployeeData.findMenuIsExist(urlPatten) == 0) {
            return null;
        }

        List<String> needRoleIds = requestEmployeeData.findRoleIdsByUrlPattern(urlPatten);
