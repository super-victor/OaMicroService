...
public interface CardHolderMapper {
     ...
     */
    CardHolder findCardHolderByName(String name, int ownerId);
     ...
     */
    CardHolder findCardHolderByCardHolderIdAndEmployeeId(int cardHolderId, int employeeId);
     ...
     * @LastChangeDate 2020/11/8
     */
    int insertCardHolderByCardHolderId(CardHolder cardHolder);
}