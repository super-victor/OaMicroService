...
//                logUtil.updateInfo("将"+meeting+"改为："+meetingData.getMeetingById(meetingid));
...
//            l.put("totalnum",meetingData.getMeetingTrendnums(departmentName));
//            List<Map<String,Object>>m=meetingData.getMeetingTrend(departmentName);
//            l.put("info",m);
